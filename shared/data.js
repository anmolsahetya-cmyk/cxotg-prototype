  ...
  tickets: [
    {
      ...
      surveyResponse: {
        ...
        questions: [
          { type: 'nps', question: 'How likely are you to recommend us to a friend or colleague?', answer: 2, scale: 10 },
          { type: 'text', question: 'What is the primary reason for your score?', answer: 'Charged twice for my renewal and no one told me why. Been a customer for 4 years — this is unacceptable.' },
          { type: 'choice', question: 'Which of the following issues have you experienced?', answer: ['Billing errors', 'Slow support response'] },
          { type: 'rating', question: 'How would you rate our billing accuracy?', answer: 1, scale: 5 },
          { type: 'text', question: 'Anything else you\'d like us to know?', answer: 'Please fix your billing system before renewal season. I shouldn\'t have to call support for a mistake on your end.' },
        ],
      },
    ...
    },
    {
      ...
      surveyResponse: {
        ...
        questions: [
          { type: 'nps', question: 'How likely are you to recommend us to a friend or colleague?', answer: 4, scale: 10 },
          { type: 'text', question: 'What is the primary reason for your score?', answer: 'Our self-check-in kiosks keep freezing mid-transaction — very frustrating for our guests.' },
          { type: 'choice', question: 'Which of the following describes your experience?', answer: ['Software crashes', 'Guest complaints', 'Repeated restarts'] },
          { type: 'rating', question: 'How would you rate the reliability of our kiosk software?', answer: 2, scale: 5 },
          { type: 'text', question: 'Anything else you\'d like us to know?', answer: 'This has happened three days in a row. We need a fix before the weekend rush.' },
        ],
      },
    ...
    },
    {
      ...
      surveyResponse: {
        ...
        questions: [
          { type: 'nps', question: 'How likely are you to recommend us to a friend or colleague?', answer: 5, scale: 10 },
          { type: 'text', question: 'What is the primary reason for your score?', answer: 'I upgraded to Premium a week ago and still can\'t access the advanced reporting features I\'m paying for.' },
          { type: 'choice', question: 'Which areas need improvement?', answer: ['Account provisioning', 'Support follow-up'] },
          { type: 'rating', question: 'How would you rate the account setup process?', answer: 2, scale: 5 },
          { type: 'text', question: 'Anything else you\'d like us to know?', answer: 'I\'ve filed this twice already with no resolution.' },
        ],
      },
    ...
    },
    {
      ...
      surveyResponse: {
        ...
        questions: [
          { type: 'nps', question: 'How likely are you to recommend us to a friend or colleague?', answer: 3, scale: 10 },
          { type: 'text', question: 'What is the primary reason for your score?', answer: 'Several onboarding steps were confusing and the help docs are outdated.' },
          { type: 'choice', question: 'What part of onboarding was difficult?', answer: ['Setup wizard', 'Documentation', 'Lack of guidance'] },
          { type: 'rating', question: 'How would you rate our onboarding experience?', answer: 1, scale: 5 },
          { type: 'text', question: 'Anything else you\'d like us to know?', answer: 'I almost gave up halfway through. A guided walkthrough would help a lot.' },
        ],
      },
    ...
    },
    {
      ...
      surveyResponse: {
        ...
        questions: [
          { type: 'nps', question: 'How likely are you to recommend us to a friend or colleague?', answer: 1, scale: 10 },
          { type: 'text', question: 'What is the primary reason for your score?', answer: 'The patient data export feature is completely broken and we have a regulatory deadline in days.' },
          { type: 'choice', question: 'Which of the following describes your experience?', answer: ['Data export failure', 'Compliance risk', 'No workaround provided'] },
          { type: 'rating', question: 'How would you rate the reliability of this feature?', answer: 0, scale: 5 },
          { type: 'text', question: 'Anything else you\'d like us to know?', answer: 'This is a P0 for us — we could face penalties if this isn\'t fixed immediately.' },
        ],
      },
    ...
    },
    {
      ...
      surveyResponse: {
        ...
        questions: [
          { type: 'nps', question: 'How likely are you to recommend us to a friend or colleague?', answer: 3, scale: 10 },
          { type: 'text', question: 'What is the primary reason for your score?', answer: 'Our invoices are showing incorrect USD/HKD conversion rates, and we\'ve been overcharged.' },
          { type: 'choice', question: 'Which of the following describes your experience?', answer: ['Billing errors', 'Currency conversion', 'Overpayment'] },
          { type: 'rating', question: 'How would you rate the accuracy of your invoices?', answer: 1, scale: 5 },
          { type: 'text', question: 'Anything else you\'d like us to know?', answer: 'We\'ve overpaid roughly HKD 4,200 across the last three invoices. Please issue a correction.' },
        ],
      },
    ...
    },
    {
      ...
      surveyResponse: {
        ...
        questions: [
          { type: 'nps', question: 'How likely are you to recommend us to a friend or colleague?', answer: 5, scale: 10 },
          { type: 'text', question: 'What is the primary reason for your score?', answer: 'I submitted a GDPR erasure request over 72 hours ago and it still hasn\'t been processed.' },
          { type: 'choice', question: 'Which of the following describes your experience?', answer: ['Compliance concern', 'Slow response', 'Legal risk'] },
          { type: 'rating', question: 'How would you rate our handling of data privacy requests?', answer: 2, scale: 5 },
          { type: 'text', question: 'Anything else you\'d like us to know?', answer: 'This is a legal requirement, not a feature request. Please prioritize.' },
        ],
      },
    ...
    },
    {
      ...
      surveyResponse: {
        ...
        questions: [
          { type: 'nps', question: 'How likely are you to recommend us to a friend or colleague?', answer: 4, scale: 10 },
          { type: 'text', question: 'What is the primary reason for your score?', answer: 'Our customers are supposed to receive surveys in Arabic, but they\'re still arriving in English.' },
          { type: 'choice', question: 'Which of the following describes your experience?', answer: ['Localization issue', 'Language settings ignored'] },
          { type: 'rating', question: 'How would you rate our support for Arabic-speaking markets?', answer: 2, scale: 5 },
          { type: 'text', question: 'Anything else you\'d like us to know?', answer: 'We\'ve configured the language setting correctly on our end — this needs to be fixed on your side.' },
        ],
      },
      issueDate: '2026-06-20',
      isOverdue: false,
    ...
    },
    {
      ...
      surveyResponse: {
        ...
        questions: [
          { type: 'nps', question: 'How likely are you to recommend us to a friend or colleague?', answer: 2, scale: 10 },
          { type: 'text', question: 'What is the primary reason for your score?', answer: 'Two-factor authentication SMS codes aren\'t reaching our employees with Japanese phone numbers.' },
          { type: 'choice', question: 'Which of the following describes your experience?', answer: ['2FA failure', 'SMS delivery issue', 'Blocked logins'] },
          { type: 'rating', question: 'How would you rate the reliability of login/authentication?', answer: 1, scale: 5 },
          { type: 'text', question: 'Anything else you\'d like us to know?', answer: 'Several of our enterprise accounts are locked out. This is blocking daily operations.' },
        ],
      },
      issueDate: '2026-06-22',
      isOverdue: false,
    ...
    },
    {
      ...
      surveyResponse: {
        ...
        questions: [
          { type: 'nps', question: 'How likely are you to recommend us to a friend or colleague?', answer: 6, scale: 10 },
          { type: 'text', question: 'What is the primary reason for your score?', answer: 'When I export survey responses to Excel, four of our custom question columns are missing from the file.' },
          { type: 'choice', question: 'Which of the following describes your experience?', answer: ['Export bug', 'Missing data', 'Reporting delay'] },
          { type: 'rating', question: 'How would you rate the reliability of the data export feature?', answer: 2, scale: 5 },
          { type: 'text', question: 'Anything else you\'d like us to know?', answer: 'This is holding up our grant reporting deadline. Please prioritize a fix.' },
        ],
      },
    ...
    },
    {
      ...
      surveyResponse: {
        ...
        questions: [
          { type: 'nps', question: 'How likely are you to recommend us to a friend or colleague?', answer: 3, scale: 10 },
          { type: 'text', question: 'What is the primary reason for your score?', answer: 'The dashboard has been unusable for over a week and support keeps closing my tickets without a real fix.' },
          { type: 'choice', question: 'Which of the following describes your experience?', answer: ['Dashboard outages', 'Unresolved tickets', 'Poor support follow-up'] },
          { type: 'rating', question: 'How would you rate the reliability of the analytics dashboard?', answer: 1, scale: 5 },
          { type: 'text', question: 'Anything else you\'d like us to know?', answer: 'We have a board report due in days and can\'t get reliable access to our own data.' },
        ],
      },
